# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-20 12:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catalog', '0002_auto_20170420_1930'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='category',
            name='meta_keywords',
            field=models.CharField(help_text=b'meta \xe5\x85\xb3\xe9\x94\xae\xe5\xad\x97\xef\xbc\x8c\xe6\x9c\x89\xe5\x88\xa9\xe4\xba\x8eseo\xef\xbc\x8c\xe7\x94\xa8\xe9\x80\x97\xe5\x8f\xb7\xe5\x88\x86\xe9\x9a\x94', max_length=255, verbose_name=b'Meta \xe5\x85\xb3\xe9\x94\xae\xe5\xad\x97'),
        ),
        migrations.AlterField(
            model_name='category',
            name='name',
        ...
        migrations.AlterField(
            model_name='product',
            name='image',
            field=models.ImageField(max_length=50, upload_to=b'', verbose_name=b'\xe5\x9b\xbe\xe7\x89\x87'),
        ),
        migrations.AlterField(
            model_name='product',
            name='is_active',
        ...
        migrations.AlterField(
            model_name='product',
            name='meta_keywords',
            field=models.CharField(help_text=b'meta \xe5\x85\xb3\xe9\x94\xae\xe8\xaf\x8d\xe6\xa0\x87\xe7\xad\xbe\xef\xbc\x8c\xe9\x80\x97\xe5\x8f\xb7\xe5\x88\x86\xe9\x9a\x94', max_length=255, verbose_name=b'Meta\xe5\x85\xb3\xe9\x94\xae\xe5\xad\x97'),
        ),
        migrations.AlterField(
            model_name='product',
            name='name',
            field=models.CharField(max_length=255, unique=True, verbose_name=b'\xe5\x90\x8d\xe7\xa7\xb0'),
        ),
        migrations.AlterField(
            model_name='product',
            name='old_price',
            field=models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=9, verbose_name=b'\xe6\x97\xa7\xe4\xbb\xb7\xe6\xa0\xbc'),
        ),
        migrations.AlterField(
            model_name='product',
            name='price',
            field=models.DecimalField(decimal_places=2, max_digits=9, verbose_name=b'\xe4\xbb\xb7\xe6\xa0\xbc'),
        ),
        migrations.AlterField(
            model_name='product',
            name='quantity',
        ...
        migrations.AlterField(
            model_name='product',
            name='slug',
            field=models.SlugField(help_text=b'\xe6\xa0\xb9\xe6\x8d\xaename\xe7\x94\x9f\xe6\x88\x90\xe7\x9a\x84\xef\xbc\x8c\xe7\x94\xa8\xe4\xba\x8e\xe7\x94\x9f\xe6\x88\x90\xe9\xa1\xb5\xe9\x9d\xa2url\xef\xbc\x8c\xe5\xbf\x85\xe9\xa1\xbb\xe5\x94\xaf\xe4\xb8\x80', max_length=255, unique=True, verbose_name=b'Slug'),
        ),
        migrations.AlterField(
            model_name='product',
            name='updated_at',
